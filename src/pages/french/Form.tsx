...
const handleInput = (e) => { //on every imput, it refreshes the ·formData· object
  ...
  const handleSubmit = () => { //called when user presses Send
        ...
        if (validateName() && validateCard() && validateViol() && validatePhone()) { //calls al validating function, if none of these finds an error with inputs it logs the formdata, that is now ready to export
          ...
          // HERE SHOULD BE THINGS YOU WANT IF THE INPUTS ARE CORRECT
        } else {//in case of an input error, it just notifies user that inputs were wrong
          setShowAlert(true);
          // HERE SHOULD BE THINGS YOU WANT IF THE INPUTS ARE INCORRECT
        }
          ...
          <IonRow>
            <IonCol className="ion-padding ion-text-center">
              <div className="button-container">
                ...
                <div className="selectortextoffset ion-text-nowrap">Informations</div>
                {/* This button does nothing, its for appearence */}
          ...
          <IonRow>
            <form className="formcontainer">
              <IonGrid>
                ...
                <IonRow>
                  <IonCol>
                    <IonInput
                      ...
                      labelPlacement="floating"
                      placeholder="Veuillez entrer les informations de votre carte d'identité."
                      className="Form-User-"
                    />
                  </IonCol>
                </IonRow>
                <IonRow>
                  <IonCol className="">
                    <IonLabel>Votre type de violation</IonLabel>
