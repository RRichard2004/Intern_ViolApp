        ...
        <IonGrid className='centeringelementsdiv'>
          ...
          <IonRow>
            <IonCol size="12" class="ion-padding ion-text-center">
              ...
              <IonButton color="color-button-primary bigbutton ion-text-nowrap" onClick={() => history.push('/french/menu')}>
              BIENVENUE
              </IonButton>
          ...
          <IonRow className='gridfooterparent'>
            <IonCol size="3">
              <IonImg src="./public/logo1.png" alt="Company1.png" className='footerimg'></IonImg>
            </IonCol>
            <IonCol size="3">
              <IonImg src="./public/logo2.png" alt="Company2.png" className='footerimg'></IonImg>
            </IonCol>
            <IonCol size="3">
              <IonImg src="./public/logo3.png" alt="Company3.png" className='footerimg'></IonImg>
            </IonCol>
            <IonCol size="3">
              <IonImg src="./public/logo4.png" alt="Company4.png" className='footerimg'></IonImg>
            </IonCol>
          </IonRow>
        </IonGrid>
      </IonContent>
